...
urlpatterns = [
    ...
    path("communication/<int:pk>/update/", ClientUpdateView.as_view(), name="client_update"),
    path("communication/<int:pk>/delete/", ClientDeleteView.as_view(), name="client_delete"),
]